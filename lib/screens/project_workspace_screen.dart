  ...
  Widget _transcribePanel() {
    return Column(
      ...
      children: [
        ...
        const Text('Type or paste a transcript now. Automatic speech-to-text can be connected later from an authorized provider.'),
        const SizedBox(height: 14),
        TextField(
      ...
      children: [
        ...
        FilledButton.icon(
          onPressed: () {
            ...
            info('Language selected: $targetLanguage. Connect a translation API to generate translated text.');
          },
        ...
        TextButton(
          ...
          child: const Text('Continue to Voice'),
        ),
      ],
    );
  }
  ...
  Widget _exportPanel() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        const Text('The project controls are ready. Final dubbed-video rendering needs a media renderer/TTS backend to be connected.'),
        const SizedBox(height: 14),
        ListTile(
